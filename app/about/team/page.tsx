...
export default function TeamPage() {
  ...
  const founder = {
    ...
    image: "/placeholder.svg?height=500&width=400&text=Chris+Wigginton",
  ...
  const lindsay = {
    ...
    image: "/placeholder.svg?height=500&width=400&text=Lindsay+Wigginton",
  ...
  const teamMembers = [
    {
      ...
      bio: "Sarah brings over 8 years of experience in structural design and analysis, specializing in seismic design and building renovations.",
      specialties: ["Seismic Design", "Steel Structures", "Building Renovations"],
    },
    {
      name: "Michael Chen, PE",
      title: "Mechanical Engineer",
      image: "/placeholder.svg?height=400&width=300&text=Michael+Chen",
      bio: "Michael leads our mechanical design team with expertise in HVAC systems, energy efficiency, and building performance optimization.",
      specialties: ["HVAC Design", "Energy Modeling", "Building Automation"],
    },
    {
      name: "Emily Rodriguez, EIT",
      title: "Electrical Engineer",
      image: "/placeholder.svg?height=400&width=300&text=Emily+Rodriguez",
      bio: "Emily specializes in electrical system design, renewable energy integration, and smart building technologies.",
      specialties: ["Electrical Design", "Solar Systems", "Smart Buildings"],
    },
  ]
      ...
      <section className="py-20 bg-slate-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button className="bg-yellow-400 text-black hover:bg-yellow-500 px-8 py-3 text-lg">Get In Touch</Button>
            </Link>
            <Link href="/projects">
              <Button
                variant="outline"
